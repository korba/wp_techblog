...
class solopine_facebook_widget extends WP_Widget {
	...
	function solopine_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'solopine_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'redwood') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'solopine_facebook_widget' );

		/* Create the widget. */
		parent::__construct( 'solopine_facebook_widget', __('Redwood: Facebook Like Box', 'redwood'), $widget_ops, $control_ops );
	}
