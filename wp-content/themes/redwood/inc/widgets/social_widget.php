...
class solopine_social_widget extends WP_Widget {
	...
	function solopine_social_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'solopine_social_widget', 'description' => __('A widget that displays your social icons', 'redwood') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'solopine_social_widget' );

		/* Create the widget. */
		parent::__construct( 'solopine_social_widget', __('Redwood: Social Icons', 'redwood'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linkedin' ); ?>">Show Snapchat:</label>
