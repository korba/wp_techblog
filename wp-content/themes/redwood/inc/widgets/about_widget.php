...
class solopine_about_widget extends WP_Widget {
	...
	function solopine_about_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'solopine_about_widget', 'description' => __('An About Me Widget', 'redwood') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'solopine_about_widget' );

		/* Create the widget. */
		parent::__construct( 'solopine_about_widget', __('Redwood: About Me', 'redwood'), $widget_ops, $control_ops );
	}
